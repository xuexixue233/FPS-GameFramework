...
namespace FPSFramework.Experimental
{
    /// <summary>
    ...
    public class FreeLookTest : MonoBehaviour
    {
        ...
        private void Update()
        {
            ...
            overlayCamera.transform.rotation = Quaternion.Euler(xRotation * mainToOverlayFOVRatio, yRotation * mainToOverlayFOVRatio, 0);
        }
    }
}