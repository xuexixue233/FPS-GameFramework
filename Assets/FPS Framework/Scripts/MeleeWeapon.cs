    ...
    public class MeleeWeapon : Weapon
    {
        ...
        public void Attack()
        {
            if (Physics.Raycast(transform.position, transform.forward, out hit, range))
            {
                ...
                if (transform == Inventory.Controller.transform) return;
                ...
                {
                    damageable.Damage(damage, Inventory.Controller.Actor);
                ...
                {
                    damageableGroup.GetDamageable().Damage(damage, Inventory.Controller.Actor);
                ...
                if (damageableGroup != null && damageable == null)
                {
                    ...
                    {
                        Inventory.Controller.Actor.ActorManager.kills++;
                        UIManager.Instance.KillFeed.Show(Inventory.Controller.Actor, damageableGroup.GetDamageable().GetActor().Name, damageableGroup.GetBone() == HumanBodyBones.Head ? true : false);
