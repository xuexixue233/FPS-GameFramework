...
namespace FPSFramework
{
    public static class FPSControllerCreator
    {
        ...
        public static void CreateFPSController()
        {
            ...
            UnityEventTools.AddPersistentListener(fpsController.OnJump, jumpKickModifier.Trigger);
            UnityEventTools.AddPersistentListener(fpsController.OnLand, landKickModifier.Trigger);
