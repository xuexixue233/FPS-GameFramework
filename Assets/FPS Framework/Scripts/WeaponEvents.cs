...
{
    [AddComponentMenu("Weapons/Weapon Events")]
    /// <summary>
    ...
    public class WeaponEvents : MonoBehaviour
    {
        ...
        {
            weapon.Inventory.Controller.GetCameraManager().ShakeCameras(multipler * cameraShakeMultipler, cameraShakeRoughness, cameraShakeFadeOutTime);
        }
