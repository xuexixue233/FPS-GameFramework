...
{
    [AddComponentMenu("Weapons/Attachments/Attachment")]
    public class Attachment : MonoBehaviour
    {
        ...
        private void UpdateSight()
        {
            ...
            {
                if (Input.GetKeyDown(KeyCode.Mouse2)) sight.index++;
        ...
        private void UpdateLaser()
        {
            ...
            if (laser)
            {
                ...
                {
                    t.gameObject.SetActive(Name == firearmAttachmentsManager.laser);
                }

                laser.enabled = (Name == firearmAttachmentsManager.laser);
            }
        }
        ...
        private void UpdateMuzzle()
        {
            ...
            if (!muzzle.fireSFX.AudioSource) AudioManager.EquipAudio(target.AudioHolder, muzzle.fireSFX);

            target.currentFireSFX = muzzle.fireSFX;
